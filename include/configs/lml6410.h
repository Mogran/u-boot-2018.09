...
/*
 * Copyright (C) 2018 Hjimi 
 * Mingliang lu <lumingliang@hjimi.com>
 *
 * Configuation settings for the SAMSUNG Universal (s5pc100) board.
 */

#ifndef __CONFIG_LML6410_H
#define __CONFIG_LML6410_H

/* High Level Configuration Options */
#define CONFIG_SAMSUNG		1	/* in a SAMSUNG core */

#define CONFIG_SYS_UBOOT_BASE	0x30000000
...
/*lml modify #define  CONFIG_SAMSUNG_ONENAND		1 */
#undef  CONFIG_SAMSUNG_ONENAND	
